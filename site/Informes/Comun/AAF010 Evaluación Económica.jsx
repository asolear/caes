import pdfUrl from './AAF010 Evaluación Económica.pdf';
...
const PDFRenderer = () => {
    ...
    const formulario= [
      ...
      // { nombre: "cT1", label: "Colu1", opciones:Object.keys(T1[Object.keys(T1)[0]]), valorPorDefecto:Object.keys(T1[Object.keys(T1)[0]])[0], ayuda: ""  }, 
       ...
       {nombre:  "I0", label: "I0", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "Bt", label: "Bt", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "i", label: "i", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "n", label: "n", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "PR", label: "PR", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "VAN", label: "VAN", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "TIR", label: "TIR", valorPorDefecto: '' ,ayuda: ""},
       {nombre:  "evaluacion", label: "evaluacion", valorPorDefecto: '' ,ayuda: ""},
